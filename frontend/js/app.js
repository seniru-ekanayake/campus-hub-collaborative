...
// Priya wrote Auth + Toast, Aiden added Http (needed for API calls with the JWT header)
...
// --- Toast notifications ---
// Small slide-in toasts — Priya built these to replace the ugly browser alert() calls
const Toast = {
  container: null,
