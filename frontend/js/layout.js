// layout.js — builds the sidebar + topbar injected on every page
// Amashi wrote most of this; the SVG icon set was a group effort going back and forth in the group chat
...
<header class="topbar" role="banner">
  ...
  <div class="topbar-right">
    ...
    <div style="position:relative">
      <button class="icon-btn has-notif" id="btn-notif" aria-label="Notifications" aria-haspopup="true" aria-expanded="false">
        ${icons.bell}
      </button>
      <div class="notif-panel hidden" id="notif-panel" role="dialog" aria-label="Notifications">
        ...
        <div class="notif-item unread" tabindex="0" role="button">
          ...
          <div>
            <div class="notif-title">New event posted</div>
        ...
        <div class="notif-item" tabindex="0" role="button">
          ...
          <div>
            <div class="notif-title">Welcome to CampusHub!</div>
  ...
  // ── BOTTOM NAV (mobile) — Phase 1 only ──────────────────────
  const bottomNavHtml = `
<nav class="bottom-nav" aria-label="Mobile navigation">
  <div class="bottom-nav-inner">
    ...
    <a href="clubs.html" class="bottom-nav-item ${activeSection==='clubs'?'active':''}" aria-label="Club Hub">
      ${icons.users}<span>Clubs</span>
    </a>
    <a href="announcements.html" class="bottom-nav-item ${activeSection==='announcements'?'active':''}" aria-label="Announcements">
      ${icons.bell}<span>News</span>
    </a>
...
window.showToast = function(title, message = '', type = 'default', duration = 4000) {
  ...
  toast.innerHTML = `
    <div class="toast-header">
      <div class="toast-title" style="display:flex;align-items:center;gap:6px">${toastIcons[type]||toastIcons.default}${title}</div>
